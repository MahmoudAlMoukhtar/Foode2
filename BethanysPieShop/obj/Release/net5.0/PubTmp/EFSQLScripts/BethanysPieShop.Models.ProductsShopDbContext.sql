...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230627160749_InitialMigration')
BEGIN
...
BEGIN
    CREATE TABLE [Products] (
        ...
        CONSTRAINT [PK_Products] PRIMARY KEY ([PieId]),
...
BEGIN
    CREATE TABLE [CartItems] (
        ...
        [ProductPieId] int NULL,
        [Quantity] int NOT NULL,
        CONSTRAINT [PK_CartItems] PRIMARY KEY ([CartItemId]),
        CONSTRAINT [FK_CartItems_Products_ProductPieId] FOREIGN KEY ([ProductPieId]) REFERENCES [Products] ([PieId]) ON DELETE NO ACTION
    );
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230627160749_InitialMigration')
BEGIN
    CREATE INDEX [IX_CartItems_ProductPieId] ON [CartItems] ([ProductPieId]);
END;
GO
...
BEGIN
    ...
    VALUES (N'20230627160749_InitialMigration', N'5.0.17');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230629145459_IdentityAdded')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230629145459_IdentityAdded', N'5.0.17');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230629164733_LogoutAdded')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230629164733_LogoutAdded', N'5.0.17');
END;
GO
